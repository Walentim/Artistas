...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        $sql = "SELECT id_artista, nome_artista, dsc_artista FROM artista WHERE nome_artista ILIKE :nome_artista";
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->rowCount() == 0) {
                    ...
                    $data = [
                        ...
                        'FK_SITUACAO_id_sit' => 3,
                        'cor_artista' => $cor_artista


                    ];

                    $sql = "INSERT INTO artista (nome_artista, dsc_artista, link_play, FK_USUARIO_id_user, dat_add_artista, FK_SITUACAO_id_sit, cor_artista) VALUES (:nome_artista, :dsc_artista, :link_play, :FK_USUARIO_id_user, :dat_add_artista, 
                        :FK_SITUACAO_id_sit, :cor_artista)";
